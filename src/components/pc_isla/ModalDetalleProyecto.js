...
function ModalDetalleProyecto({
  ...
  const actualizarEncargadosSii = async () => {
    ...
    if (
      proyecto.encargado_sii.id === encargadosSiiSelections.encargadoSii &&
  ...
  const [isAccepted, setIsAccepted] = useState(
    proyecto.oficio_respuesta !== null
  );
                        ...
                        <p className="text-gris-900 cursor-default">
                          ...
                          {user &&
                            (user.is_pc_isla_admin ||
                              ...
                              <a className="anchor-editar-institucion">
                                <ArrowPathIcon
                      ...
                      >
                        ...
                        <p className="text-gris-900 cursor-default">
                          ...
                          {user &&
                            (user.is_pc_isla_admin ||
                              user.is_pc_isla_editor) && (
                              <a className="anchor-editar-encargados">
                                <PencilSquareIcon
                      ...
                      >
                        <div className="flex flex-col sm-sii:flex-row mb-4">
                          <div className="w-full sm-sii:w-2/5 sm-sii:pr-3">
                            <label
                              className="text-gris-700 text-sm"
                              id="encargado-label"
                            >
                              Editar encargado
                            </label>
                            ...
                            />
                            <span
                              className="text-rojo-400 text-sm"
                              hidden={encargadosSiiValidations.encargado}
                            >
                          ...
                          <div className="w-full sm-sii:w-2/5">
                            ...
                            <span
                              className="text-rojo-400 text-sm"
                              hidden={encargadosSiiValidations.backup}
                            >
                              Debe seleccionar un backup.
                            </span>
                            <span
                              className="text-rojo-400 text-sm"
                              hidden={encargadosSiiValidations.backup2}
                            >
                              El backup debe ser distinto del encargado.
                            </span>
                          </div>
                        ...
                        <div className="mb-2 px-6 pb-4 pt-4 bg-gris-300">
                          ...
                          <div className="mt-1">
                            ...
                            <p className="text text-gris-900 cursor-default">
                              ...
                              {user &&
                                (user.is_pc_isla_admin ||
                                  user.is_pc_isla_editor) && (
                                  <a className="anchor-editar-encargadoIE">
                                    <PencilSquareIcon
                                ...
                                <>
                                  ...
                                  >
                                    ...
                                    {index === 0 &&
                                      ...
                                      (user.is_pc_isla_admin ||
                                        user.is_pc_isla_editor) && (
                                        <a className="anchor-editar-investigadores">
                                          <PencilSquareIcon
                                            //onClick={handleEditarEncargadoIE}
                                            className="h-6 w-6 text-gris-800 hover:text-azul-cobalto-400 inline cursor-pointer"
                                          />
                          ...
                          <div className="mt-1">
                            ...
                            <div className="flex sm-sii:flex-row flex-col">
                              ...
                              <div className="flex flex-row">
                                <BloquesSelected bloques={proyecto.jornada} />
                              </div>
                            </div>
                          </div>
                        </div>
