...
class CustomUserAdmin(BaseUserAdmin):
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('username', 'password1', 'password2', 'is_active', 'is_staff', 'is_pc_isla_editor', 'is_pc_isla_admin', 'is_convenios_editor', 'is_convenios_admin', 'is_buscador_editor', 'is_buscador_admin', 'persona', 'is_superuser'),
        }),
    )
